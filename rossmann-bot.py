...
#delete Webhook
#https://api.telegram.org/bot6070726420:AAGIzDDjcTKLDDnYv8JnfRPklSNsxiJyEao/deleteWebhook
...
#https://api.telegram.org/bot6070726420:AAGIzDDjcTKLDDnYv8JnfRPklSNsxiJyEao/setWebhook?url=https://4461-2804-14d-c887-905e-46b-f729-d0ee-8646.sa.ngrok.io
...
if __name__ == '__main__':
    ...
    app.run( host ='0.0.0.0', port= port ) #5000 é a porta padrão do flask
